...
public class IP4Address implements Comparable<IP4Address> {
  ...
  public static IP4Address next(IP4Address address)
  ...
  public IP4Address(String address) throws UnknownHostException {
    ...
    mInteger = ((mByteArray[0] & 0xFF) << 24) + ((mByteArray[1] & 0xFF) << 16) +
  ...
  public byte[] toByteArray() { return mByteArray; }

  public String toString() { return mString; }

  public int toInteger() { return mInteger; }

  public InetAddress toInetAddress() { return mAddress; }
