...
public class RequestParser {
  ...
  private static final String[] TLD = {".com.ac",
                                       ".edu.ac",
                                       ".gov.ac",
                                       ".net.ac",
                                       ".mil.ac",
  ...
  public static String getBaseDomain(String hostname) {
    ...
    for (String tld : TLD) {
      if (hostname.endsWith(tld)) {
        String[] host_parts = hostname.split("\\."), tld_parts =
                                                         tld.split("\\.");
        int itld = tld_parts.length, ihost = host_parts.length, i = 0;
    ...
    int startIndex = 0, nextIndex = hostname.indexOf('.'),
  ...
  public static String getUrlFromRequest(String hostname, String request) {
    ...
    if (headers != null && headers.length > 0) {
      ...
      int slash = req.indexOf('/'), space = req.lastIndexOf(' ');
  ...
  public static ArrayList<HttpCookie> parseRawCookie(String rawCookie) {
    ...
    for (String rawCookieParam : rawCookieParams) {
      ...
      for (int i = 1; i < rawCookieParams.length; i++) {
        String rawCookieParamNameAndValue[] =
            rawCookieParams[i].trim().split("=");
  ...
  public static ArrayList<HttpCookie>
  getCookiesFromHeaders(ArrayList<String> headers) {
  ...
  public static String getCharsetFromHeaders(String contentType) {
    if (contentType != null &&
        contentType.toLowerCase().trim().contains("charset=")) {
